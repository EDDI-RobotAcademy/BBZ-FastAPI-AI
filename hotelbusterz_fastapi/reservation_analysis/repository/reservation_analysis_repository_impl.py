...
from hotelbusterz_fastapi.reservation_analysis.repository.reservation_analysis_repository import ReservationAnalysisRepository


class ReservationAnalysisRepositoryImpl(ReservationAnalysisRepository):
    async def prepareReservationInfo(self, dataFrame):
        X = dataFrame['len_of_reservation', 'num_of_adult', 'num_of_child', 'is_exist_car'].values.reshape(0, 1)
